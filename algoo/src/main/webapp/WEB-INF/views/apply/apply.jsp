...
<body>
	<form action="<c:url value='/apply/apply.ag'/>" method="post">
		<input type="hidden" name="recCode" value="${param.recCode }">
		<input type="hidden" name="memberCode" value="${sessionScope.userid }">
		...
		<div style="text-align: center; height: 100px; margin-top: 10px;">
			<input type="submit" value="지원하기" style="display: inline-block;
