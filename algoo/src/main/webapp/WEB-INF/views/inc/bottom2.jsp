		...
		<div id="footer">
			<div id="footer_div">
				<div id="footer_menu">
					...
					<a href="http://corp.alba.co.kr/about/Inquiry.asp"  target="_blank">제휴 및 배너광고 문의</a>
					...
					<a href="<c:url value='/sitemap.ag'/>">사이트맵</a>
				</div>
				<div id="footer_main">
					...
					<div id="footer_comintro">
						<address>서울특별시 강남구 역삼동 707-24번지 한신인터밸리24 동관 20층 (주)미디어윌 네트웍스 <br>
								 ...
								 제공사업 신고번호: 서울강남 제2008-30호 | 개인정보보호 책임자: 박기란 Life2@algoo.co.kr
						</address>
						<a href="https://www.facebook.com/" target="_blank"><img alt="패밀리1" src="<%=request.getContextPath()%>/images/family_1.png"></a> 
						<a href="https://www.google.ee" target="_blank"><img alt="패밀리2" src="<%=request.getContextPath()%>/images/family_2.png"></a> 
						<a href="https://twitter.com/" target="_blank"><img alt="패밀리3" src="<%=request.getContextPath()%>/images/family_3.png"></a> 
					</div>
