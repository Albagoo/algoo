...
<div class="adminBoard">
	...
	<div class="adminList">
		...
		<form action="<c:url value='/admin/adminBoard.ag'/> " method="post" id="frmCount">	
			...
			<input type="text" id="num" name="name">개 
			<input type="button" value="출력" id="btNco">
			<input type="hidden" name="nco">
			<div>
				<table style="width: 100%;" class="box1">
					...
					<tbody>
						...
						<c:set var="i" value="0" />
						<c:if test="${empty print || print==0}">
							<c:set var="print" value="7" />
						</c:if>
						<c:forEach var="nVo" items="${nlist }" end="${print}">
							<tr>
								<td>
		...
		<div class="adminFaq">
			...
			<div>
				<table style="width: 100%;" class="box1">
					...
					<tbody>
						<c:set var="j" value="0" />
						<c:forEach var="fVo" items="${flist }" end="7">
							<tr>
								<td>
		...
		<div class="adminFree">
			...
			<div>
				<table style="width: 100%;" class="box2">
					...
					<tbody>
						<c:set var="k" value="0" />
						<c:forEach var="tVo" items="${tlist }" end="7">
							<tr>
								<td>
