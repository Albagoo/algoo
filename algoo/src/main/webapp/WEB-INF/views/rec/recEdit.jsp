...
function k(wel,index,item,ids,names) {
   ...
   $("#regBt").click(function() {
      ...
      return false;
         ...
         frm1.action = "<c:url value='/rec/recEdit.ag'/>";
         frm1.submit();
      }
      });//click
...
style="width: 150px;height: 100px;border: 1px solid gray"> 
			...
			<dl class="clearBoth renceWrite">
				...
				<dt>
					<span class="titd">전화번호</span> <input type="text" class="phone1"
						name="phone1" placeholder="02" maxlength="3" readonly="readonly"
						value="${compVo.phone1 }"> <input type="text"
						class="phone2" name="phone2" placeholder="0000" maxlength="4"
						value="${compVo.phone2 }"> <input type="text" readonly="readonly"
				...
				<dt class="clearBoth">
					...
					readonly="readonly"
						...
						readonly="readonly" value="${compVo.hp3 }">
				</dt>
				<dt>
					<span class="titd">팩스번호</span> <input type="text" class="phone1"
						name="fax1" placeholder="010" maxlength="3" readonly="readonly"
						value="${compVo.fax1 }"> <input type="text" class="phone2"
						name="fax2" placeholder="0000" maxlength="4" readonly="readonly"
						value="${compVo.fax2 }"> <input type="text" class="phone3"
						name="fax3" placeholder="0000" maxlength="4" readonly="readonly"
						value="${compVo.fax3 }">
				</dt>
				<dt>
					<span class="titd">e-mail</span> <input type="text" class="email1"
						...
						class="floatLeft" id=email2 disabled="disabled">
      ...
      <div class="detailContent">
         <div>
            <textarea id="content" name="detailRecruit" rows="12" cols="40">${recVo.detailRecruit }</textarea>
         </div>
      </div>
   </div>
