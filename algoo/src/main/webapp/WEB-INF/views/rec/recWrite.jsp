...
style="width: 150px;height: 100px;border: 1px solid gray"> 
		...
		<div class="recContent bg checks">
			<dl class="clearBoth">
				<dt>
					<span class="titc">모집인원 </span> <input type="text" class="txt_35"
						placeholder="00명" name="recruitMember"> <input
						type="checkbox" id="tenPeople" name="recruitMember" value="0명">
					<label for="tenPeople"> 0명 </label> <input type="checkbox"
						id="hundredPeople" name="recruitMember" value="00명"> <label
						for="hundredPeople">00명 </label>
				</dt>
				<dt>
					<span class="tit" c>모집대상</span> <input type="checkbox" id="youth"
				...
				<dt>
					<span class="titc">모집종료일</span>
					  ...
					  name="recruitDeadline" checked="checked"
					  size="30">
