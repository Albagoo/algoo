...
<div id="memInfo">
	<div style="padding: 10px; height: 100%">
		<h2 style="font-size: 1.4em; font-weight: bold;
					border-bottom: 3px solid #E70400; padding: 10px; ">채용 공고 관리</h2>
		<table style="width: 100%;">	
			...
			<c:forEach var="vo" items="${alist }">
				<tr style="text-align: center; border-bottom: 1px solid #e6e6e6;">
					...
					<td>
					<a href="<c:url value='/apply/updateReadCheck.ag?applyCode=${vo.applyCode }&readCheck=${vo.readCheck }&hisCode=${vo.hisCode }'/>"
						style="font-weight: normal;">${vo.username }<span style="font-size: 0.6em; color: silver">(이력서 보기)</span></a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
